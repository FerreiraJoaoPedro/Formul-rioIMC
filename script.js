const calcular = document.getElementById('calcular');
	...
	function imc () {
		...
		if (nome !== '' && altura !== '' && peso !== '') {
			...
			resultado.textContent = 'Olá, ' +nome+'! Com '+peso+'kg e '+altura+'m seu IMC é '+valorIMC+' e você está '+classificacao+'.Sua faixa de peso ideal está entre '+pesoMinimo+'kg e '+pesoMaximo+'kg!';
		}
